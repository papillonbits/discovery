...
export function uiUpdatePipelinesObjectsSteps(state, action) {
  ...
  const newPipelinesObjectsSteps = updatePipelinesObjects({
    pipelinesObjects: objectsSelected[0].steps,
    object: pipelinesSelectedInstance.edit.step,
  })
