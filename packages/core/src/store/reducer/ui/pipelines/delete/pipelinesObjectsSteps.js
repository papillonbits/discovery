...
export function uiDeletePipelinesObjectsSteps(state, action) {
  ...
  const newPipelinesObjectsSteps = deletePipelinesObjects({
    pipelinesObjects: objectsSelected[0].steps,
    selectedObjects: action.payload.selectedObjectsSteps,
  })
